...
1. THE TimelineViewport SHALL accept `visibleStart` and `visibleEnd` parameters
2. THE TimelineRowsViewport SHALL accept `visibleStart` and `visibleEnd` parameters
3. THE TimelineViewport SHALL remove dependency on TimelineController
4. THE TimelineRowsViewport SHALL remove dependency on TimelineController
