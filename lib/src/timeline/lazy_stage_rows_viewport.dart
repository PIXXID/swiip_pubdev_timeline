...
class _LazyStageRowsViewportState extends State<LazyStageRowsViewport> {
  ...
  void _updateVisibleRowRange() {
    ...
    // Add buffer
    final start = (firstVisibleRow - widget.bufferRows).clamp(0, widget.stagesRows.length - 1);
    final end = (lastVisibleRow + widget.bufferRows).clamp(0, widget.stagesRows.length - 1);
